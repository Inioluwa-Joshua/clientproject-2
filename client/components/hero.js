        ...
        <Container className="flex flex-wrap ">
          <div className="flex items-center w-full lg:w-1/2">
            <div className="max-w-2xl mb-8">
              <h1 className="text-[3.75rem] leading-[4rem] font-bold tracking-tight text-[#14161b] lg:text-[3.75rem] xl:text-[3.75rem] dark:text-white">
                Create beautiful converting content with AI
              </h1>
              <p className="py-5 text-[18px] leading-normal text-[#71799b] lg:text-[18px] xl:text-[18px] dark:text-[#71799b] font-[500]">
              ...
              <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="py-[12px] px-[32px] text-lg font-medium text-center text-white bg-[#7168fa!important] rounded-md "
                >
                  Start for free
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener"
                  className="flex items-center space-x-2 text-[#14161B] dark:text-[#fff]"
                >
